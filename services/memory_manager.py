...
# Use a local path within the project to avoid permission issues in some environments
DEFAULT_DB_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "geotab_memories.db")
